...
import siteInfoValidWithDevices from "../../fixtures/site-info/test-site-many-devices.json";
import siteInfoValidwithoutDevices from "../../fixtures/site-info/test-site-no-devices.json";
